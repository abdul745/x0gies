...
import { merkleFunc } from "./merkle.js";
...
const getContract = (signer: Signer) => {
  return new ethers.Contract(
    "0xBb6f5dA9090Ac1F90b608Aee30E3FA28e1bdf221",
    CONTRACT_ABI,
    signer,
  );
};
export { handleSectionNavigation, web3, merkleFunc, getContract };